            ...
            < Vehicle/>
             ...
             <div className='model' >
                    ...
                    <div className='power-input'>
                        <input id="ccm" name="ccm" placeholder="Price from" value={priceFrom} onChange={(e)=> setPriceFrom(e.target.value)} />
                        <input id="ccm-1" name="ccm-1" placeholder="Price to" value={priceTo} onChange={(e)=> setPriceTo(e.target.value)} />
                    </div>
                </div>
